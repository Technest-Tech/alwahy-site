    ...
    <section id="packages" class="section relative">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="card <?php echo e($index === 1 ? 'border-gold-400 border-2 scale-105' : ''); ?>">
                    <div class="text-center mb-6">
                        <h3 class="text-2xl font-bold text-gold-400 mb-2"><?php echo e(app()->getLocale() === 'ar' ? $package->name_ar : $package->name_en); ?></h3>
                        <div class="text-3xl font-bold mb-2"><?php echo e($package->sessions_per_week); ?> <?php echo e(app()->getLocale() === 'ar' ? 'جلسات/أسبوع' : 'Sessions/Week'); ?></div>
                        <div class="text-xl text-gold-400 mb-2">
                            $<?php echo e(number_format($package->price, 2)); ?> <?php echo e(app()->getLocale() === 'ar' ? '/أسبوع' : '/week'); ?>

                        </div>
                        <div class="text-sm text-gray-400">
                            <?php echo e(app()->getLocale() === 'ar' ? '$5 لكل ساعة' : '$5 per hour'); ?>

                        </div>
                    </div>
                    <p class="text-gray-300 mb-6 text-center"><?php echo e(app()->getLocale() === 'ar' ? $package->description_ar : $package->description_en); ?></p>
            ...
            <form id="registrationForm" action="<?php echo e(route('register.store')); ?>" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="whatsapp" required class="form-input" value="<?php echo e(old('whatsapp')); ?>" placeholder="+20 106 534 0432">
                    </div>
