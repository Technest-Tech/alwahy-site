...
@section('content')
    ...
    <section id="packages" class="section relative">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach($staticPackages as $index => $package)
                <div class="card {{ $package['badge'] === 'Most Popular' ? 'border-gold-400 border-2 scale-105' : '' }} relative">
                    ...
                    <div class="text-center mb-6">
                        ...
                        <div class="flex items-center justify-center gap-2 mb-2">
                            ...
                            <span class="text-xl text-gray-500 price-strikethrough">${{ number_format($package['original_price'], 0) }}</span>
                            @endif
                            <span class="text-3xl font-bold text-gold-400">${{ number_format($package['price'], 0) }}</span>
                        </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
                <div class="card">
                    ...
                    <div class="space-y-4">
                        <a href="https://www.facebook.com/share/1Bsd7Wz83W/?mibextid=wwXIfr" target="_blank" class="flex items-center space-x-3 rtl:space-x-reverse text-gray-300 hover:text-gold-400 transition">
            ...
            <form id="registrationForm" action="{{ route('register.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="whatsapp" required class="form-input" value="{{ old('whatsapp') }}" placeholder="+971566674605">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="package_id" id="package_id" required class="form-input">
                            ...
                            @foreach($staticPackages as $package)
